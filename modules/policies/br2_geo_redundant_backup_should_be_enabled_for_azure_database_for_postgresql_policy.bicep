...
param client string
output policyId string = br2_geo_redundant_backup_should_be_enabled_for_azure_database_for_postgresql_policy.id
resource br2_geo_redundant_backup_should_be_enabled_for_azure_database_for_postgresql_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
