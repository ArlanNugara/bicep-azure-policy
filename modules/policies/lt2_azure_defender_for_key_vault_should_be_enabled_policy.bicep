...
param client string
output policyId string = lt2_azure_defender_for_key_vault_should_be_enabled_policy.id
resource lt2_azure_defender_for_key_vault_should_be_enabled_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
