...
param client string
output policyId string = pa2_management_ports_of_virtual_machines_should_be_protected_with_just_in_time_network_access_control_policy.id
resource pa2_management_ports_of_virtual_machines_should_be_protected_with_just_in_time_network_access_control_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
