...
resource im6_mfa_should_be_enabled_on_accounts_with_read_permissions_on_your_subscription_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
  name: '${client}-MFA should be enabled on accounts with read permissions on your subscription'
  properties: {
    displayName: '${client}-MFA should be enabled on accounts with read permissions on your subscription'
    policyType: 'Custom'
    mode: 'All'
