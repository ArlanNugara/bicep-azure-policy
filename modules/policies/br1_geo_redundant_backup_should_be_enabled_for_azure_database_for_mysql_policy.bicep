...
param client string
output policyId string = br1_geo_redundant_backup_should_be_enabled_for_azure_database_for_mysql_policy.id
resource br1_geo_redundant_backup_should_be_enabled_for_azure_database_for_mysql_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
