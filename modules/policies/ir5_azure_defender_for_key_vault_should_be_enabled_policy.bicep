...
param client string
output policyId string = ir5_azure_defender_for_key_vault_should_be_enabled_policy.id

resource ir5_azure_defender_for_key_vault_should_be_enabled_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
  name: '${client}-'
  properties: {
    displayName: '${client}-'
    policyType: 'Custom'
