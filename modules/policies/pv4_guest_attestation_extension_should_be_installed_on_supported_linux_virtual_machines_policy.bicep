...
param client string
output policyId string = pv4_guest_attestation_extension_should_be_installed_on_supported_linux_virtual_machines_policy.id
resource pv4_guest_attestation_extension_should_be_installed_on_supported_linux_virtual_machines_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
  name: '${client}-Guest Attestation extension should be installed on supported Linux virtual machines'
  properties: {
    displayName: '${client}-Guest Attestation extension should be installed on supported Linux virtual machines'
    policyType: 'Custom'
    mode: 'Indexed'
