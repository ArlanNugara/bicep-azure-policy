...
param client string
output policyId string = es2_endpoint_protection_health_issues_should_be_resolved_on_your_machines_policy.id
resource es2_endpoint_protection_health_issues_should_be_resolved_on_your_machines_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
