...
param client string
output policyId string = ir3_azure_defender_for_dns_should_be_enabled_policy.id
resource ir3_azure_defender_for_dns_should_be_enabled_policy 'Microsoft.Authorization/policyDefinitions@2021-06-01' = {
